...
function createMenuItem(obj, name, price, catagory){
    obj = {name, price, catagory}
    return obj
}
...
*/
console.log(createMenuItem("eggs", 2, "breakfest"));
...
reviews.push({name:"Casey", rating:5, feedback:"good stuff"})
